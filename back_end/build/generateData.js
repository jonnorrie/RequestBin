...
async function main() {
    ...
    for (const masterToken of masterTokens) {
        ...
        for (let b = 0; b < BASKETS_PER_TOKEN; b++) {
            ...
            await pool.query(`INSERT INTO baskets (endpoint, config_response, master_token_id) VALUES ($1, $2, $3)`, [endpoint, { createdAt: new Date().toISOString() }, masterTokenId]);
           ...
           VALUES ($1, $2, $3, $4, $5, $6)`, [basketId, requestData.method, requestData.headers, requestData.request_date, requestData.request_time, mongoDoc._id.toString()]);
